//
//  PestsAndDiseasesViewController.m
//  Agrochemical
//
...
@interface PestsAndDiseasesViewController ()<UIScrollViewDelegate,UIGestureRecognizerDelegate,knowledgeListParserDelegate,KnowledgeCatListParserDelegate,newsListViewDelegate>
...
@implementation PestsAndDiseasesViewController
...
-(void)getNewsDataParser{
    ...
    [parser requestWithCat2Id:338 withCatId:0 withKeyWord:@"" withPageNum:1 withPageSize:model.pageSize withShowStatus:1 withCropId:[model.myId integerValue]];
