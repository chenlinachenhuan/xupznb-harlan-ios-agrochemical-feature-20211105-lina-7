...
- (void)setupLabels {
	label = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, self.bounds.size.width, 45)];
...
- (void)layoutSubviews {
	...
	label.frame = CGRectMake(round((bounds.size.width - labelSize.width) / 2) + xPos, yPos-15, labelSize.width, 45);
