...
//        titleLabel.shadowOffset = CGSizeMake(1, 1);
    ...
    window.center = CGPointMake(CGRectGetMidX(rcScreen),ScreenHeight-34- button.frame.size.height / 2);
    window.hidden = NO;
    ...
    NSTimer *timer1 = [NSTimer timerWithTimeInterval:((float)self.settings._delay+self.settings._duration)/500
