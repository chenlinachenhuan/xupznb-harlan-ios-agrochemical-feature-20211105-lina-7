...
- (void)viewDidLayoutSubviews {
    ...
    CGFloat statusBarHeight1 = isFullScreen ? [TZCommonTools tz_statusBarHeight] : 0;
    CGFloat statusBarHeightInterval = isFullScreen ? (statusBarHeight1 - 20) : 0;
    CGFloat naviBarHeight = statusBarHeight1 + _tzImagePickerVc.navigationBar.tz_height;
